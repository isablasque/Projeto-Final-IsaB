...
namespace LoginProjeto.Migrations
{
    ...
    [Migration("20231205113216_Criacao-Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoginProjeto.Models.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.EntradaProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.Fornecedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.Pais", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.SaidaProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.TipoProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.TipoSaida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginProjeto.Models.Cidade", b =>
                {
                    b.HasOne("LoginProjeto.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginProjeto.Models.Cliente", b =>
                {
                    b.HasOne("LoginProjeto.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginProjeto.Models.EntradaProduto", b =>
                {
                    b.HasOne("LoginProjeto.Models.Produto", "Produto")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginProjeto.Models.Estado", b =>
                {
                    b.HasOne("LoginProjeto.Models.Pais", "Pais")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginProjeto.Models.Produto", b =>
                {
                    b.HasOne("LoginProjeto.Models.Fornecedor", "Fornecedor")
                        .WithMany()
                        .HasForeignKey("FornecedorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LoginProjeto.Models.TipoProduto", "TipoProduto")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginProjeto.Models.SaidaProduto", b =>
                {
                    b.HasOne("LoginProjeto.Models.Cliente", "Cliente")
                        .WithMany()
                    ...
                    b.HasOne("LoginProjeto.Models.TipoSaida", "TipoSaida")
                        .WithMany()
                        .HasForeignKey("TipoSaidaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LoginProjeto.Models.Usuario", "Usuario")
                        .WithMany()
